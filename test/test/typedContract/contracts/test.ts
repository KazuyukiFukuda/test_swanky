...
import ABI from '../../artifacts/test.json';
import QueryMethods from '../query/test';
import BuildExtrinsicMethods from '../build-extrinsic/test';
import TxSignAndSendMethods from '../tx-sign-and-send/test';
import MixedMethods from '../mixed-methods/test';
import EventsClass from '../events/test';

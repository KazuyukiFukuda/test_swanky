...
import type * as ArgumentTypes from '../types-arguments/test';
import type * as ReturnTypes from '../types-returns/test';
...
export default class Methods {
	...
	*/
	"getHatedAccount" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "getHatedAccount", [], __options , (result) => { return handleReturnType(result, getTypeDescription(2, 'test')); });
	}
	...
	*/
	"transferFrom" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "psp22::transferFrom", [from, to, value, data], __options , (result) => { return handleReturnType(result, getTypeDescription(13, 'test')); });
	}
	...
	*/
	"increaseAllowance" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "psp22::increaseAllowance", [spender, deltaValue], __options , (result) => { return handleReturnType(result, getTypeDescription(13, 'test')); });
	}
	...
	*/
	"transfer" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "psp22::transfer", [to, value, data], __options , (result) => { return handleReturnType(result, getTypeDescription(13, 'test')); });
	}
	...
	*/
	"decreaseAllowance" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "psp22::decreaseAllowance", [spender, deltaValue], __options , (result) => { return handleReturnType(result, getTypeDescription(13, 'test')); });
	}
	...
	*/
	"approve" (
		...
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "psp22::approve", [spender, value], __options , (result) => { return handleReturnType(result, getTypeDescription(13, 'test')); });
	}
